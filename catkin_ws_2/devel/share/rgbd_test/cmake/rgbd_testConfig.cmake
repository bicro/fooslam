...
if("TRUE" STREQUAL "TRUE")
  set(rgbd_test_SOURCE_PREFIX /home/viki/catkin_ws_2/src/rgbd_test)
  set(rgbd_test_DEVEL_PREFIX /home/viki/catkin_ws_2/devel)
  ...
  set(rgbd_test_INSTALL_PREFIX /home/viki/catkin_ws_2/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rgbd_test' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ee125 <ee125@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rgbd_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/viki/catkin_ws_2/src/rgbd_test/${idir}'.  Ask the maintainer 'ee125 <ee125@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/viki/catkin_ws_2/devel/lib;/opt/ros/indigo/lib)
